class ProductsController < ApplicationController
    def index
        ...
        @products = gt_data("https://elektra.vteximg.com.br/api/catalog_system/pub/products/GetProductAndSkuIds?categoryId=#{params['category_id']}&_from=1&_to=10")
        @products_list = []
        @products['data'].each do |product_id|
          ...
          product = gt_data("https://elektra.vteximg.com.br/api/catalog_system/pub/products/ProductGet/#{product_id[0]}")
  ...
  def show
    ...
    @product = gt_data("https://elektra.vteximg.com.br/api/catalog_system/pub/products/#{id}/specification")
  end
end
